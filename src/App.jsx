        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label className="block">
              <span className="text-[#CDD6F4] text-sm font-medium mb-1 block">Number of Questions (1-20)</span>
              <input
                ...
                <ul className="space-y-3">
                  {q.options.map((option, optIndex) => (
                    <li key={optIndex} className="flex items-center">
                      ...
                      />
                      <label htmlFor={`q${qIndex}-opt${optIndex}`} className="ml-3 text-[#CDD6F4] cursor-pointer text-base">
        ...
        {results && (
          <div className="mt-8 space-y-6">
            <div className="text-center">
              ...
              <p className="text-xl text-[#CDD6F4]">
                Your accuracy is <span className="font-bold text-[#A6E3AD]">{results.accuracy.toFixed(2)}%</span>.
              </p>
            </div>
              ...
              {questions.map((q, qIndex) => (
                <div key={qIndex} className="bg-[#181825] p-6 rounded-2xl shadow-inner border border-[#45475A]">
                  ...
                  <p className="text-[#CDD6F4] font-medium">
                    Your Answer: <span className={answers[qIndex] === q.correctAnswer ? "text-[#A6E3AD]" : "text-[#F38BA8]"}>{answers[qIndex] || 'Not answered'}</span>
                  </p>
                  <p className="text-[#CDD6F4] font-medium">
